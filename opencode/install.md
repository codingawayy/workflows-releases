...
Download the six command files to the scope-appropriate commands directory. The files are:
...
- `workflows-build-skills.md` — `https://raw.githubusercontent.com/codingawayy/workflows-releases/main/opencode/commands/workflows-build-skills.md`
...
for verb in add-item author build-skills run-item discuss unblock; do
...
workflows-build-skills/SKILL.md
workflows-build-skills/reference/operation-contract.md
