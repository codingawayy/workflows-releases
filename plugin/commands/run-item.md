...
The first argument is the item id (e.g. `B26.071`); an optional second argument names the exact
transition to take at a forked status. If no item id was provided, ask the user which item to drive.
